...
@group(1) @binding(1) var<uniform> target_size: vec4f;
...
@vertex fn vs_main(in: VertexInput) -> VertexOutput {
    ...
    out.blur_uv0 = center_uv + vec2f(0.0, px_size * f32(-5));
    out.blur_uv1 = center_uv + vec2f(0.0, px_size * f32(-4));
    out.blur_uv2 = center_uv + vec2f(0.0, px_size * f32(-3));
    out.blur_uv3 = center_uv + vec2f(0.0, px_size * f32(-2));
    out.blur_uv4 = center_uv + vec2f(0.0, px_size * f32(-1));
    out.blur_uv5 = center_uv + vec2f(0.0, px_size * f32(0));
    out.blur_uv6 = center_uv + vec2f(0.0, px_size * f32(1));
    out.blur_uv7 = center_uv + vec2f(0.0, px_size * f32(2));
    out.blur_uv8 = center_uv + vec2f(0.0, px_size * f32(3));
    out.blur_uv9 = center_uv + vec2f(0.0, px_size * f32(4));
    out.blur_uv10 = center_uv + vec2f(0.0, px_size * f32(5));
