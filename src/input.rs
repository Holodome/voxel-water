...
impl Input {
    ...
    pub fn is_mouse_up(&self, mb: MouseButton) -> bool {
        !self.now_mouse[mouse_button_to_usize(mb)]
    }
    pub fn is_mouse_pressed(&self, mb: MouseButton) -> bool {
        self.now_mouse[mouse_button_to_usize(mb)] && !self.prev_mouse[mouse_button_to_usize(mb)]
    }
    ...
    pub fn handle_mouse_button(&mut self, state: ElementState, button: MouseButton) {
        let button = mouse_button_to_usize(button);
        match state {
